...
# python test.py --batch_size 32 --test_dataset data/test_data --pdb_dir example/example_pdb --h5_file example/example.h5 --model saved_model/deepAMPNet.pth --prefix out
...
def parse_args():
    ...
    parser.add_argument('--prefix', type=str, default=None, help='prefix of output csv')
        ...
        # --- 在这里添加以下两行 ---
    parser.add_argument('--pdb_dir', type=str, help='path of raw pdb files directory')
    parser.add_argument('--h5_file', type=str, help='path of raw h5 features file')
    # -------------------------
...
def main():
    ...
    test_dataset = StructureDataset(root=args.test_dataset,
