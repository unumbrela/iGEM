...
# 这是【正确】的MyModel定义，请用它替换掉 AMP_Classification_Prediction.py 中的旧版本
class MyModel(nn.Module):
    def __init__(self):
        super().__init__()
        self.bert1 = AutoModelForSequenceClassification.from_pretrained(model_checkpoint1, num_labels=3000)
        # 保持与训练脚本一致，冻结bert1的参数
